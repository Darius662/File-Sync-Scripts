...
$folders = @("Folder_IN", "Proj_in")

# Define source and destination directories
#$sourceE = "E:\"
#$sourceZ = "Z:\Folder\project1"
#$folders = @("Folder_IN", "Proj_in")
...
function UploadFolder {
    ...
    if (Test-Path -Path $sourceFolderPath) {
        ...
        # Move all files from the source folder to the destination
        Get-ChildItem -Path $sourceFolderPath -File -Recurse | ForEach-Object {
